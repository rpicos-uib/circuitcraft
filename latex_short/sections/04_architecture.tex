...
% straight through the block and blockentity boxes' text in between. The block and client
% boxes' text above is now forced onto two lines, like the other three boxes, rather than one
% long unbroken line -- their single-line text was wide enough to silently grow those two
% boxes past the other three's 6.2cm width (minimum width is only a lower bound), which is
% what left this dogleg's clearance too tight in practice despite the 0.6cm offset.
