...
Section~\ref{sec:minecraft-mechanics}). Faust~\cite{faust2024minecraft} goes further,
developing a set of redstone-based laboratory exercises that teach combinational digital
logic directly within an introductory electronics course, with students building logic gates
in Minecraft before encountering the same designs in physical hardware. This is the
literature to which CircuitCraft is
