...
The function generator's amplitude and frequency, unlike its waveform shape, are not set by
a preset cycled on the block itself but by a separate control mechanism entirely distinct
from the MNA network described above; Section~\ref{sec:control-network} describes it in
detail.
