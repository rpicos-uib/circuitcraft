...
charge-controlled state equation, which is left as future work; recent results toward exactly
such a model, including Bode-plot-based extraction from real flexible-memristor
measurements, are given in~\cite{gater2026smallsignal,gater2025bodeplots}.
\end{itemize}
