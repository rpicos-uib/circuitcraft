...
\emph{Electrician}, a new villager profession that sells the mod's other seventeen items for
...
as it successfully trades, unlocking further tiers of stock rather than offering all
seventeen items from the outset. The five tiers were chosen to mirror the order a learner
would naturally be introduced to the material: Novice sells the passive elements (wire,
ground, resistor, capacitor, inductor); Apprentice, the DC/time-varying sources and their
adjustment modules; Journeyman, the AC Source; Expert, the three oscilloscope probes; and
Master, the memristor alone, reserved for last as the component whose behavior depends on the
integral of its own history rather than an instantaneous relation. Trades are themselves
