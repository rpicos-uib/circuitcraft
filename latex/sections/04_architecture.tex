...
(A and B respectively) and stamps a fixed DC voltage source of $V = A \times 15 + B$ onto its
remaining wired lead, exposing a 0--240~V range at effectively $1/15\,\mathrm{V}$ resolution
from two ordinary redstone signals. The V2R Converter performs the exact inverse: it reads
