...
This paper describes which of Minecraft's own construction mechanics the mod builds on top
of, the system's software architecture, the circuit-theoretic design decisions behind it (in
particular, an explicit, player-placeable ground reference), the pedagogical rationale for
embedding a correct solver inside a game environment rather than a dedicated simulator, and
the verification methodology used during development. We conclude with current limitations
and a roadmap for classroom evaluation.
\end{abstract}
